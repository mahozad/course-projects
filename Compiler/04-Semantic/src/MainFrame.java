...
class MainFrame extends JFrame {
    ...
    boolean canReRun = false;
    private ASTFrame ast;

    MainFrame(ASTFrame frame) {
        super("Miva Compiler");
        ast = frame;
    ...
    private void initComponents() {
        fileLabel.setText("Source file address:");
    ...
    void showLexemesAndErrors(List<Token> tokenList, List<String> errorList) {
        for (Token token : tokenList) {
            lexemesTextfield.setText(lexemesTextfield.getText() +
                    (lexemesTextfield.getText().equals("") ? "" : "\n") + token);
        }
    ...
    void showParsingError(String error) {
        errorsTextfield.setText(errorsTextfield.getText() + (errorsTextfield
                .getText().equals("") ? "" : "\n") + error);
    }

    void showSemanticError(String error) {
        errorsTextfield.setText(errorsTextfield.getText() + (errorsTextfield
                .getText().equals("") ? "" : "\n") + error);
    }
    ...
    void showNoError() {
        ...
        errorsTextfield.setText("No error");
    }
    ...
    private void actionPerformed() {
        ...
        if (fileIsValid()) {
            ...
            lexemesTextfield.setText("");
            errorsTextfield.setText("This file does not exist");
        }
    }
